            ...
            <div className='menu'>
                ...
                <section id='Popular items'>
                    ...
                    <div className='row features-box'>
                        ...
                        {data.filter(data => data.category === 'smartphones').map((ele, index) =>{
                            ...
                            return (
                                <div key={index} className='col-lg-5 features-item' href="https://websiteonlinedemo.com/hoi/index.php?route=product/quick_view&product_id=42 ">
                                   <NavLink to={`/details/${ele.id}`}> <img className='feature-img' src={ele.thumbnail} alt='...' /></NavLink>
                                    <div className='description'>
                                    <NavLink to={`/details/${ele.id}`} ><h6 key={ele.index} className='quickbox'><b> {ele.title}</b></h6>
                                        <p>{ele.description}</p>  </NavLink> 
                ...
                <section id='Beverages'>
                    ...
                    <div className='row features-box'>
                        ...
                        {data.filter(data => data.category === 'skincare').map((ele, index) => {
                ...
                <section id='Breads'>
                    ...
                    <div className='row features-box'>
                        ...
                        {data.filter(data => data.category === 'fragrances').map((ele, index) => {
                ...
                <section id='Burgers'>
                    ...
                    <div className='row features-box'>
                        ...
                        {data.filter(data => data.category === 'laptops').map((ele, index) => {
                ...
                <section id='Chaat Corner'>
                    ...
                    <div className='row features-box'>
                        ...
                        {data.filter(data => data.category === 'groceries').map((ele, index) => {
